...
def probe_bybit_mainnet_readonly_activity(
    *,
    ...
    """Read the latest 24h account activity only after public clock readiness succeeds."""
    ...
    if snapshot.api_host != preflight.api_host:
        raise RuntimeError("Bybit activity and clock preflight came from different API hosts")
    return snapshot
