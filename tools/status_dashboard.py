...
h1,h2{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;text-wrap:balance;margin:0}
h1{
...
.eyebrow{
  font-family:ui-monospace,SFMono-Regular,Consolas,"Liberation Mono",monospace;font-size:11px;font-weight:500;
...
.shead .n{font-family:ui-monospace,SFMono-Regular,Consolas,"Liberation Mono",monospace;font-size:12px;color:var(--text3)}
.verdict{
  border:2px solid var(--crit);background:var(--surface);padding:18px 20px;
  display:flex;flex-direction:column;gap:8px;
}
.verdict .t{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;font-weight:700;font-size:17px;color:var(--crit)}
...
.pill{
  font-family:ui-monospace,SFMono-Regular,Consolas,"Liberation Mono",monospace;font-size:11.5px;padding:3px 10px;
...
.cell .v{
  font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;font-size:23px;font-weight:700;
...
.gatebox .t{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;font-weight:600;color:var(--warn);font-size:14.5px}
...
footer{
  ...
  font-size:12px;color:var(--text3);font-family:ui-monospace,SFMono-Regular,Consolas,"Liberation Mono",monospace;
}
